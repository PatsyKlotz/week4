...
//first argument is the STARTING position (0)
//second argument is HOW MANY to take out (0,2)
//colorList.splice(0,3);
colorList.reverse;
...
function onImageClick(evt)
{
  ...
  purchasedImages.push(selectedImage);//push adds the element to the new array, update_shopping_cart();
...
function update_shopping_cart()
{
  ...
  //evt.target.setAttribute("style", "padding: 5em; ");
